...
module.exports = {
  ...
  UpdateUserName: ApiUrl + '/zhyz/miniapp/api/user/updateUserName',
  UpdateUserPhoneNo: ApiUrl + '/zhyz/miniapp/api/user/updatePhoneNo',
  ...
  EquipmentToMigrate: ApiUrl + '/zhyz/miniapp/api/equipment/toMigrate',
  EquipmentCameraDetail: ApiUrl + '/zhyz/miniapp/api/equipment/cameraDetail',
