...
Page({
  ...
  updatePushInterval: function () {
    const _this = this;
    wx.navigateTo({
      url: '/pages/equipment/alarm/conf2/update/pushInterval?confId=' + _this.data.conf.confId,
    });
  },
  updatePushType: function () {
    const _this = this;
    wx.navigateTo({
      url: '/pages/equipment/alarm/conf2/update/pushType?confId=' + _this.data.conf.confId,
    });
  },
